...
VL_ATTR_COLD void test_4_conditional_constrain___024unit___ctor_var_reset(test_4_conditional_constrain___024unit* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    test_4_conditional_constrain__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        test_4_conditional_constrain___024unit___ctor_var_reset\n"); );
}
