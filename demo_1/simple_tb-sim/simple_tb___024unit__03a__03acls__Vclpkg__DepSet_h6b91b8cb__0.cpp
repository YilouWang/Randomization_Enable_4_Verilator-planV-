...
void simple_tb___024unit__03a__03acls::__VnoInFunc_enum_con_setup_constraint(simple_tb__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          simple_tb___024unit__03a__03acls::__VnoInFunc_enum_con_setup_constraint\n"); );
    // Body
